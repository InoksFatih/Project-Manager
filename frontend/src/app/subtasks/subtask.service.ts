...
export class SubtaskService {
  ...
  public getAllSubtasks(): Observable<Subtask[]> {
    return this.http.get<Subtask[]>(`${this.host}/getAllSubtasks`);
  }
  ...
  public getSubtask(subtaskId: number): Observable<Subtask> {
    return this.http.get<Subtask>(`${this.host}/getSubtask/${subtaskId}`);
  }
